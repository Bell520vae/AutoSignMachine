...
let freeDownFloorAd = {
  ...
  findAll: async (axios, options) => {
    let res = await axios
      ...
      .catch((err) => console.log("000000000000000000000000000000000000000000"));
    console.log(res.data);
  },
  onAdClick: async (axios, options, appinfo) => {
    ...
    let res = await axios
      ...
      .catch((err) => console.log("000000000000000000000000000000000000000"));
    console.log(res.data);
  ...
  onAdAppDownloadStart: async (axios, options, appinfo) => {
    ...
    let res = await axios
      ...
      .catch((err) => console.log("000000000000000000000000000000000000000000000"));
    console.log(res.data);
    console.log("等待15秒再继续");
    // eslint-disable-next-line no-unused-vars
    await new Promise((resolve, reject) => setTimeout(resolve, 15 * 1000));
  ...
  onAdAppDownloadSucceed: async (axios, options, appinfo) => {
    ...
    let res = await axios
      ...
      .catch((err) => console.log("00000000000000000000000000000000000000000"));
    console.log(res.data);
    console.log("等待15秒再继续");
    // eslint-disable-next-line no-unused-vars
    await new Promise((resolve, reject) => setTimeout(resolve, 15 * 1000));
